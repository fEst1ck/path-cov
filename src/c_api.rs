...
unsafe fn get_path_reducer(top_level: *const TopLevel, k: c_int) -> *const PathReducer<BlockID, BlockID> {
...
unsafe fn reduce_path(reducer: *const PathReducer<BlockID, BlockID>, path: *const BlockID, path_size: c_int, entry_fun_id: FunID) -> *const c_char {
